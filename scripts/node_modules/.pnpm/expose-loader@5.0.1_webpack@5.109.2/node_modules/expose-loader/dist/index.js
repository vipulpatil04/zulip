...
function loader() {
  ...
  const newRequest = (0, _utils.contextify)(this, this.context, this.remainingRequest);
  ...
  const getGlobalThis = options.globalObject || `require(${(0, _utils.stringifyRequest)(this, require.resolve("./runtime/getGlobalThis.js"))})`;
