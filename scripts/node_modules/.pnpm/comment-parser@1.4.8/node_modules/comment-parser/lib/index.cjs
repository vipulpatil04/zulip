...
exports.parse = parse;
const index_js_1 = __importDefault(require("./parser/index.cjs"));
const description_js_1 = __importDefault(require("./parser/tokenizers/description.cjs"));
const name_js_1 = __importDefault(require("./parser/tokenizers/name.cjs"));
const tag_js_1 = __importDefault(require("./parser/tokenizers/tag.cjs"));
const type_js_1 = __importDefault(require("./parser/tokenizers/type.cjs"));
const index_js_2 = __importDefault(require("./stringifier/index.cjs"));
const align_js_1 = __importDefault(require("./transforms/align.cjs"));
const indent_js_1 = __importDefault(require("./transforms/indent.cjs"));
const crlf_js_1 = __importDefault(require("./transforms/crlf.cjs"));
...
Object.defineProperty(exports, "inspect", {
  enumerable: true,
  get: function () {
    return __importDefault(inspect_js_1).default;
  }
});
exports.transforms = {
