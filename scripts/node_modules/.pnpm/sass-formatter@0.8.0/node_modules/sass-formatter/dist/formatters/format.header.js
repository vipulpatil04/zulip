...
function FormatBlockHeader(line, STATE) {
    ...
    if (STATE.CONFIG.convert &&
        (0, regex_1.isScssOrCss)(line.get()) &&
        !(0, regex_1.isComment)(line.get())) {
        ...
        STATE.LOCAL_CONTEXT.indentation = (0, utility_1.getIndentationOffset)(line.get(), STATE.CONTEXT.indentation, STATE.CONFIG.tabSize);
        hasBeenConverted = true;
    }
    // Set offset.
    let offset = STATE.LOCAL_CONTEXT.isAdjacentSelector && STATE.CONTEXT.wasLastLineSelector
        ? STATE.CONTEXT.lastSelectorIndentation - STATE.LOCAL_CONTEXT.indentation.distance
        : (0, utility_1.getBlockHeaderOffset)(STATE.LOCAL_CONTEXT.indentation.distance, STATE.CONFIG.tabSize, STATE.CONTEXT.indentation, STATE.LOCAL_CONTEXT.isReset);
    ...
    if (STATE.CONFIG.insertSpaces ? /\t/g.test(line.get()) : / /g.test(line.get())) {
        line.set((0, utility_1.replaceSpacesOrTabs)(line.get(), STATE));
