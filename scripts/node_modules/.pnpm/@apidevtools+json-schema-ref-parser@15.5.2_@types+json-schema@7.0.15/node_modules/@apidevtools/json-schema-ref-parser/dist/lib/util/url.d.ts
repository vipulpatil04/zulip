 ...
 */
export declare function resolveUrlSafety(path: string | unknown): Promise<UrlSafetyResult>;
export declare function isUnsafeUrlWithDns(path: string | unknown): Promise<boolean>;
/**
