...
export declare class $RefParser<S extends object = JSONSchema, O extends ParserOptions<S> = ParserOptions<S>> {
     ...
     */
    parse(schema: boolean, options?: O): Promise<boolean>;
    parse(path: string, schema: boolean, options: O): Promise<boolean>;
    ...
    static parse<O extends ParserOptions<JSONSchema> = ParserOptions<JSONSchema>>(schema: boolean, options?: O): Promise<boolean>;
    static parse<O extends ParserOptions<JSONSchema> = ParserOptions<JSONSchema>>(path: string, schema: boolean, options: O): Promise<boolean>;
     ...
     */
    static bundle<O extends ParserOptions<JSONSchema> = ParserOptions<JSONSchema>>(schema: boolean, options?: O): Promise<boolean>;
    static bundle<O extends ParserOptions<JSONSchema> = ParserOptions<JSONSchema>>(path: string, schema: boolean, options: O): Promise<boolean>;
    ...
    static bundle<S extends object = JSONSchema, O extends ParserOptions<S> = ParserOptions<S>>(path: string, schema: S | string | unknown, options: O, callback: SchemaCallback<S>): Promise<void>;
    /**
     * Bundles all referenced files/URLs into a single schema that only has internal `$ref` pointers. This lets you split-up your schema however you want while you're building it, but easily combine all those files together when it's time to package or distribute the schema to other people. The resulting schema size will be small, since it will still contain internal JSON references rather than being fully-dereferenced.
     *
     * This also eliminates the risk of circular references, so the schema can be safely serialized using `JSON.stringify()`.
     ...
     * @param callback (optional) A callback that will receive the bundled schema object
     */
    bundle(schema: boolean, options?: O): Promise<boolean>;
    bundle(path: string, schema: boolean, options: O): Promise<boolean>;
     ...
     */
    static dereference<O extends ParserOptions<JSONSchema> = ParserOptions<JSONSchema>>(schema: boolean, options?: O): Promise<boolean>;
    static dereference<O extends ParserOptions<JSONSchema> = ParserOptions<JSONSchema>>(path: string, schema: boolean, options: O): Promise<boolean>;
     ...
     * @param callback (optional) A callback that will receive the dereferenced schema object
     */
    dereference(schema: boolean, options?: O): Promise<boolean>;
    dereference(path: string, schema: boolean, options: O): Promise<boolean>;
