...
declare class Pointer<S extends object = JSONSchema, O extends ParserOptions<S> = ParserOptions<S>> {
     ...
     */
    set(obj: S, value: JSONSchema4Type | JSONSchema6Type | JSONSchema7Type, options?: O): string | number | boolean | S | import("json-schema").JSONSchema4Array | import("json-schema").JSONSchema4Object | null;
    /**
